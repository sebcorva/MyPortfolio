...
export const translations: Record<string, { profile: ProfileData; chat: Record<ChatPhase, MessageData[]> }> = {
    ...
    en: {
        ...
        chat: {WELCOME: [
            ...
            { text: 'Hi, my name is Sebastian Corvalan.\nI am a Computer Systems Analyst and\nSoftware Development Engineer in training.', isBot: false }
        ],
        ABOUT_ME: [
        ...
        SKILLS_PENDING: [
            ...
            { text: 'Tools: Git/GitHub, Docker, Postman, AWS, Linux', isBot: false },
